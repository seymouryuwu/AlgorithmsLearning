...
class TrieWD {
    private TrieWD[] successors;
    private boolean isWord;
    private String word;

    public TrieWD() {
        successors = new TrieWD[26];
        for (int i = 0; i < 26; i++) {
            successors[i] = null;
        }
    ...
    public void addWord(String word) {
        ...
        for (int i = 0; i < wordArray.length; i++) {
            ...
            if (curr.successors[c - 'a'] == null) {
                curr.successors[c - 'a'] = new TrieWD();
            }
    ...
    public boolean search(String word) {
        ...
        for (int i = 0; i < wordArray.length; i++) {
            ...
            if (c != '.') {
                ...
                for (TrieWD successor : curr.successors) {
                    if (successor != null &&
    ...
    private boolean find(String word, int index, TrieWD curr) {
